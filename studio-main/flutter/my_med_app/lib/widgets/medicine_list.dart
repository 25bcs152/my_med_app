...
class MedicineList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Enforcing List View as per "interface should look like the image" request
              ...
              children: details.entries.map((e) => Padding(
                ...
                child: Row(
                  children: [
                    ...
                    // Apply translation to label (key)
                    Text(appState.t(e.key.toLowerCase()), style: TextStyle(color: Colors.grey.shade600, fontSize: 12)),
                    const Spacer(),
             ...
             if (showAdd) ...[
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: Text(appState.t('add_to_my_medicines')), 
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () {
                       ...
                       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('${title} ${appState.t('removed')}')));
                    },
                    icon: const Icon(LucideIcons.trash2, size: 16),
                    label: Text(appState.t('remove')),
                    style: OutlinedButton.styleFrom(
